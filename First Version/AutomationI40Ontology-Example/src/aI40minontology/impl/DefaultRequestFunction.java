 ...
 * Source Class: DefaultRequestFunction <br>
 * @version generated on Sun Feb 10 20:58:15 COT 2019 by Santiago
 */
public class DefaultRequestFunction extends WrappedIndividualImpl implements RequestFunction {

    public DefaultRequestFunction(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Service> getCallsAService() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_CALLSASERVICE,
                                               DefaultService.class);
    }

    public boolean hasCallsAService() {
	   return !getCallsAService().isEmpty();
    }

    public void addCallsAService(Service newCallsAService) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_CALLSASERVICE,
                                       newCallsAService);
    }

    public void removeCallsAService(Service oldCallsAService) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_CALLSASERVICE,
                                          oldCallsAService);
    }
