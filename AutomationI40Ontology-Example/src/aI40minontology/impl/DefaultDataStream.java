 ...
 * Source Class: DefaultDataStream <br>
 * @version generated on Sun Feb 10 20:58:15 COT 2019 by Santiago
 */
public class DefaultDataStream extends WrappedIndividualImpl implements DataStream {

    public DefaultDataStream(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends State> getProvidesInformationToState() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_PROVIDESINFORMATIONTOSTATE,
                                               DefaultState.class);
    }

    public boolean hasProvidesInformationToState() {
	   return !getProvidesInformationToState().isEmpty();
    }

    public void addProvidesInformationToState(State newProvidesInformationToState) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_PROVIDESINFORMATIONTOSTATE,
                                       newProvidesInformationToState);
    }

    public void removeProvidesInformationToState(State oldProvidesInformationToState) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_PROVIDESINFORMATIONTOSTATE,
                                          oldProvidesInformationToState);
    }
