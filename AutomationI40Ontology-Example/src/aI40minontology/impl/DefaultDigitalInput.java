...
public class DefaultDigitalInput extends WrappedIndividualImpl implements DigitalInput {
    ...
    public Collection<? extends Entity> getReadsAbout() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_READSABOUT,
                                               DefaultEntity.class);
    }

    public boolean hasReadsAbout() {
	   return !getReadsAbout().isEmpty();
    }

    public void addReadsAbout(Entity newReadsAbout) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_READSABOUT,
                                       newReadsAbout);
    }

    public void removeReadsAbout(Entity oldReadsAbout) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_READSABOUT,
                                          oldReadsAbout);
    }
