 ...
 * Source Class: DefaultAs_a_ServiceFunction <br>
 * @version generated on Sun Feb 10 20:58:15 COT 2019 by Santiago
 */
public class DefaultAs_a_ServiceFunction extends WrappedIndividualImpl implements As_a_ServiceFunction {

    public DefaultAs_a_ServiceFunction(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Service> getRunsAService() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_RUNSASERVICE,
                                               DefaultService.class);
    }

    public boolean hasRunsAService() {
	   return !getRunsAService().isEmpty();
    }

    public void addRunsAService(Service newRunsAService) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_RUNSASERVICE,
                                       newRunsAService);
    }

    public void removeRunsAService(Service oldRunsAService) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_RUNSASERVICE,
                                          oldRunsAService);
    }
