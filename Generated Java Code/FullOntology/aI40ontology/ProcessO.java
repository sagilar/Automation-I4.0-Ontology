 ...
 * Source Class: ProcessO <br>
 * @version generated on Fri Feb 26 14:35:08 COT 2021 by santiago
 */

public interface ProcessO extends WrappedIndividual {

    /* ***************************************************
     * Property http://www.semanticweb.org/santiago/Automation-I4.0-Ontology#belongsToSubdomain
     */
     
    /**
     * Gets all property values for the belongsToSubdomain property.<p>
     * 
     * @returns a collection of values for the belongsToSubdomain property.
     */
    Collection<? extends Domain> getBelongsToSubdomain();

    /**
     * Checks if the class has a belongsToSubdomain property value.<p>
     * 
     * @return true if there is a belongsToSubdomain property value.
     */
    boolean hasBelongsToSubdomain();

    /**
     * Adds a belongsToSubdomain property value.<p>
     * 
     * @param newBelongsToSubdomain the belongsToSubdomain property value to be added
     */
    void addBelongsToSubdomain(Domain newBelongsToSubdomain);

    /**
     * Removes a belongsToSubdomain property value.<p>
     * 
     * @param oldBelongsToSubdomain the belongsToSubdomain property value to be removed.
     */
    void removeBelongsToSubdomain(Domain oldBelongsToSubdomain);


    /* ***************************************************
     * Property http://www.semanticweb.org/santiago/Automation-I4.0-Ontology#hasAssociatedModel
     */
     ...
     */
    Collection<? extends DynamicsModel> getHasAssociatedModel();
     ...
     */
    void addHasAssociatedModel(DynamicsModel newHasAssociatedModel);
     ...
     */
    void removeHasAssociatedModel(DynamicsModel oldHasAssociatedModel);
