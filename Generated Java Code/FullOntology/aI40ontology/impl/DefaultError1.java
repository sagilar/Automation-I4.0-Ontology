 ...
 * Source Class: DefaultError1 <br>
 * @version generated on Mon Feb 22 13:47:49 COT 2021 by sagga
 */
public class DefaultError1 extends WrappedIndividualImpl implements Error1 {

    public DefaultError1(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Unit> getHas_unit() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HAS_UNIT,
                                               DefaultUnit.class);
    }

    public boolean hasHas_unit() {
	   return !getHas_unit().isEmpty();
    }

    public void addHas_unit(Unit newHas_unit) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HAS_UNIT,
                                       newHas_unit);
    }

    public void removeHas_unit(Unit oldHas_unit) {
