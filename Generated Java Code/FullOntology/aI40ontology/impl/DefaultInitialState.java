 ...
 * Source Class: DefaultInitialState <br>
 * @version generated on Mon Feb 22 13:47:49 COT 2021 by sagga
 */
public class DefaultInitialState extends WrappedIndividualImpl implements InitialState {

    public DefaultInitialState(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Sequence> getInitializesSequence() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_INITIALIZESSEQUENCE,
                                               DefaultSequence.class);
    }

    public boolean hasInitializesSequence() {
	   return !getInitializesSequence().isEmpty();
    }

    public void addInitializesSequence(Sequence newInitializesSequence) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_INITIALIZESSEQUENCE,
                                       newInitializesSequence);
    }

    public void removeInitializesSequence(Sequence oldInitializesSequence) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_INITIALIZESSEQUENCE,
                                          oldInitializesSequence);
    }
