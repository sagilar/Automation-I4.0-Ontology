 ...
 * Source Class: DefaultSoftwareResource <br>
 * @version generated on Mon Feb 22 13:47:49 COT 2021 by sagga
 */
public class DefaultSoftwareResource extends WrappedIndividualImpl implements SoftwareResource {

    public DefaultSoftwareResource(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Foaf:thing> getMbox() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_MBOX,
                                               DefaultFoaf:thing.class);
    }
    ...
    public void addMbox(Foaf:thing newMbox) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_MBOX,
                                       newMbox);
    }

    public void removeMbox(Foaf:thing oldMbox) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_MBOX,
                                          oldMbox);
    }
