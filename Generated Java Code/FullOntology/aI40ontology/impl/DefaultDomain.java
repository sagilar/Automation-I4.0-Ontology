...
public class DefaultDomain extends WrappedIndividualImpl implements Domain {
    ...
    public Collection<? extends Object> getHas_Domain_Name() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_DOMAIN_NAME, Object.class);
    }

    public boolean hasHas_Domain_Name() {
		return !getHas_Domain_Name().isEmpty();
    }

    public void addHas_Domain_Name(Object newHas_Domain_Name) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_DOMAIN_NAME, newHas_Domain_Name);
    }

    public void removeHas_Domain_Name(Object oldHas_Domain_Name) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_DOMAIN_NAME, oldHas_Domain_Name);
    }
