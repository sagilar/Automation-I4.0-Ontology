...
public class DefaultEntity extends WrappedIndividualImpl implements Entity {
    ...
    public Collection<? extends Collection> getIs_member_of() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_IS_MEMBER_OF,
                                               DefaultCollection.class);
    }

    public boolean hasIs_member_of() {
	   return !getIs_member_of().isEmpty();
    }

    public void addIs_member_of(Collection newIs_member_of) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_IS_MEMBER_OF,
                                       newIs_member_of);
    }

    public void removeIs_member_of(Collection oldIs_member_of) {
