...
public class DefaultService extends WrappedIndividualImpl implements Service {
    ...
    public Collection<? extends URI> getHasURI() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASURI, URI.class);
    }

    public boolean hasHasURI() {
		return !getHasURI().isEmpty();
    }

    public void addHasURI(URI newHasURI) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASURI, newHasURI);
    }

    public void removeHasURI(URI oldHasURI) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASURI, oldHasURI);
    }
