 ...
 * Source Class: DefaultStandardPart <br>
 * @version generated on Fri Feb 26 14:35:08 COT 2021 by santiago
 */
public class DefaultStandardPart extends WrappedIndividualImpl implements StandardPart {

    public DefaultStandardPart(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends String> getStd_Part_Name() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_STD_PART_NAME, String.class);
    }

    public boolean hasStd_Part_Name() {
		return !getStd_Part_Name().isEmpty();
    }

    public void addStd_Part_Name(String newStd_Part_Name) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_STD_PART_NAME, newStd_Part_Name);
    }

    public void removeStd_Part_Name(String oldStd_Part_Name) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_STD_PART_NAME, oldStd_Part_Name);
    }
