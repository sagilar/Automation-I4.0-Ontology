...
public class DefaultArchitecture extends WrappedIndividualImpl implements Architecture {
    ...
    public Collection<? extends Actor> getIsComposedOf() {
    ...
    public void addIsComposedOf(Actor newIsComposedOf) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_ISCOMPOSEDOF,
                                       newIsComposedOf);
    }

    public void removeIsComposedOf(Actor oldIsComposedOf) {
    ...
    public Collection<? extends Network> getIsDeployedThrough() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ISDEPLOYEDTHROUGH,
                                               DefaultNetwork.class);
    }

    public boolean hasIsDeployedThrough() {
	   return !getIsDeployedThrough().isEmpty();
    }

    public void addIsDeployedThrough(Network newIsDeployedThrough) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_ISDEPLOYEDTHROUGH,
                                       newIsDeployedThrough);
    }

    public void removeIsDeployedThrough(Network oldIsDeployedThrough) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_ISDEPLOYEDTHROUGH,
                                          oldIsDeployedThrough);
    }
