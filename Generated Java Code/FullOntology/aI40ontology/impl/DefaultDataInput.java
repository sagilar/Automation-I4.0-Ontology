 ...
 * Source Class: DefaultDataInput <br>
 * @version generated on Fri Feb 26 14:35:08 COT 2021 by santiago
 */
public class DefaultDataInput extends WrappedIndividualImpl implements DataInput {

    public DefaultDataInput(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends ObjectO> getMonitors() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_MONITORS,
                                               DefaultObjectO.class);
    }

    public boolean hasMonitors() {
	   return !getMonitors().isEmpty();
    }

    public void addMonitors(ObjectO newMonitors) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_MONITORS,
                                       newMonitors);
    }

    public void removeMonitors(ObjectO oldMonitors) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_MONITORS,
                                          oldMonitors);
    }
