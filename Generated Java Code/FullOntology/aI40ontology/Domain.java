...
public interface Domain extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property https://w3id.org/i40/sto#domainName
     */
     
    /**
     * Gets all property values for the has_Domain_Name property.<p>
     * 
     * @returns a collection of values for the has_Domain_Name property.
     */
    Collection<? extends Object> getHas_Domain_Name();

    /**
     * Checks if the class has a has_Domain_Name property value.<p>
     * 
     * @return true if there is a has_Domain_Name property value.
     */
    boolean hasHas_Domain_Name();

    /**
     * Adds a has_Domain_Name property value.<p>
     * 
     * @param newHas_Domain_Name the has_Domain_Name property value to be added
     */
    void addHas_Domain_Name(Object newHas_Domain_Name);

    /**
     * Removes a has_Domain_Name property value.<p>
     * 
     * @param oldHas_Domain_Name the has_Domain_Name property value to be removed.
     */
    void removeHas_Domain_Name(Object oldHas_Domain_Name);
