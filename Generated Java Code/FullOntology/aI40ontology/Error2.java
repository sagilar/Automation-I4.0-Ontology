 ...
 * Source Class: Error2 <br>
 * @version generated on Fri Feb 26 14:35:08 COT 2021 by santiago
 */

public interface Error2 extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.ontology-of-units-of-measure.org/resource/om-2/hasNumericalValue
     */
     
    /**
     * Gets all property values for the has_numerical_value property.<p>
     * 
     * @returns a collection of values for the has_numerical_value property.
     */
    Collection<? extends Object> getHas_numerical_value();

    /**
     * Checks if the class has a has_numerical_value property value.<p>
     * 
     * @return true if there is a has_numerical_value property value.
     */
    boolean hasHas_numerical_value();

    /**
     * Adds a has_numerical_value property value.<p>
     * 
     * @param newHas_numerical_value the has_numerical_value property value to be added
     */
    void addHas_numerical_value(Object newHas_numerical_value);

    /**
     * Removes a has_numerical_value property value.<p>
     * 
     * @param oldHas_numerical_value the has_numerical_value property value to be removed.
     */
    void removeHas_numerical_value(Object oldHas_numerical_value);
