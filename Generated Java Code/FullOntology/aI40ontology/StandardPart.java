 ...
 * Source Class: StandardPart <br>
 * @version generated on Mon Feb 22 13:47:49 COT 2021 by sagga
 */

public interface StandardPart extends Publication {
    ...
    /* ***************************************************
     * Property https://w3id.org/i40/sto#stoPartName
     */
     
    /**
     * Gets all property values for the std_Part_Name property.<p>
     * 
     * @returns a collection of values for the std_Part_Name property.
     */
    Collection<? extends String> getStd_Part_Name();

    /**
     * Checks if the class has a std_Part_Name property value.<p>
     * 
     * @return true if there is a std_Part_Name property value.
     */
    boolean hasStd_Part_Name();

    /**
     * Adds a std_Part_Name property value.<p>
     * 
     * @param newStd_Part_Name the std_Part_Name property value to be added
     */
    void addStd_Part_Name(String newStd_Part_Name);

    /**
     * Removes a std_Part_Name property value.<p>
     * 
     * @param oldStd_Part_Name the std_Part_Name property value to be removed.
     */
    void removeStd_Part_Name(String oldStd_Part_Name);
