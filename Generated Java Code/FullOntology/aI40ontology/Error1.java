 ...
 * Source Class: Error1 <br>
 * @version generated on Fri Feb 26 14:35:08 COT 2021 by santiago
 */

public interface Error1 extends WrappedIndividual {

    /* ***************************************************
     * Property http://www.ontology-of-units-of-measure.org/resource/om-2/hasUnit
     */
     
    /**
     * Gets all property values for the has_unit property.<p>
     * 
     * @returns a collection of values for the has_unit property.
     */
    Collection<? extends Unit> getHas_unit();

    /**
     * Checks if the class has a has_unit property value.<p>
     * 
     * @return true if there is a has_unit property value.
     */
    boolean hasHas_unit();

    /**
     * Adds a has_unit property value.<p>
     * 
     * @param newHas_unit the has_unit property value to be added
     */
    void addHas_unit(Unit newHas_unit);

    /**
     * Removes a has_unit property value.<p>
     * 
     * @param oldHas_unit the has_unit property value to be removed.
     */
    void removeHas_unit(Unit oldHas_unit);
