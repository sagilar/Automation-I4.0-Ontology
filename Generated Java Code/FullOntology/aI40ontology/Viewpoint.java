 ...
 * Source Class: Viewpoint <br>
 * @version generated on Mon Feb 22 13:47:49 COT 2021 by sagga
 */

public interface Viewpoint extends Standard_Classification {
    ...
    /* ***************************************************
     * Property https://w3id.org/i40/sto#frames
     */
     
    /**
     * Gets all property values for the frames property.<p>
     * 
     * @returns a collection of values for the frames property.
     */
    Collection<? extends Concern> getFrames();

    /**
     * Checks if the class has a frames property value.<p>
     * 
     * @return true if there is a frames property value.
     */
    boolean hasFrames();

    /**
     * Adds a frames property value.<p>
     * 
     * @param newFrames the frames property value to be added
     */
    void addFrames(Concern newFrames);

    /**
     * Removes a frames property value.<p>
     * 
     * @param oldFrames the frames property value to be removed.
     */
    void removeFrames(Concern oldFrames);
