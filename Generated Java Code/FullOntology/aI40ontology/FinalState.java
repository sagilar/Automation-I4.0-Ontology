...
public interface FinalState extends State {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/santiago/Automation-I4.0-Ontology#finalizesSequence
     */
     
    /**
     * Gets all property values for the finalizesSequence property.<p>
     * 
     * @returns a collection of values for the finalizesSequence property.
     */
    Collection<? extends Sequence> getFinalizesSequence();

    /**
     * Checks if the class has a finalizesSequence property value.<p>
     * 
     * @return true if there is a finalizesSequence property value.
     */
    boolean hasFinalizesSequence();

    /**
     * Adds a finalizesSequence property value.<p>
     * 
     * @param newFinalizesSequence the finalizesSequence property value to be added
     */
    void addFinalizesSequence(Sequence newFinalizesSequence);

    /**
     * Removes a finalizesSequence property value.<p>
     * 
     * @param oldFinalizesSequence the finalizesSequence property value to be removed.
     */
    void removeFinalizesSequence(Sequence oldFinalizesSequence);
