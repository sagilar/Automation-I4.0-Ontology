...
public interface InitialState extends State {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/santiago/Automation-I4.0-Ontology#initializesSequence
     */
     
    /**
     * Gets all property values for the initializesSequence property.<p>
     * 
     * @returns a collection of values for the initializesSequence property.
     */
    Collection<? extends Sequence> getInitializesSequence();

    /**
     * Checks if the class has a initializesSequence property value.<p>
     * 
     * @return true if there is a initializesSequence property value.
     */
    boolean hasInitializesSequence();

    /**
     * Adds a initializesSequence property value.<p>
     * 
     * @param newInitializesSequence the initializesSequence property value to be added
     */
    void addInitializesSequence(Sequence newInitializesSequence);

    /**
     * Removes a initializesSequence property value.<p>
     * 
     * @param oldInitializesSequence the initializesSequence property value to be removed.
     */
    void removeInitializesSequence(Sequence oldInitializesSequence);
