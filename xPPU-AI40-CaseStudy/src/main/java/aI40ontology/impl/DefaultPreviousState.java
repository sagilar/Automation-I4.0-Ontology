 ...
 * Source Class: DefaultPreviousState <br>
 * @version generated on Fri Feb 26 14:03:01 COT 2021 by santiago
 */
public class DefaultPreviousState extends WrappedIndividualImpl implements PreviousState {

    public DefaultPreviousState(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
